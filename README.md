In this project, I wrote a program in Java programming language, in Visual Studio Code, to generate random passwords based on the characters the user wants to use and the length he chooses. 
